...
int main() {
	...
	//int num_time_steps = 20;//position_meas.size();
	ParticleFilter pf;
	double total_error[3] = {0,0,0};
	double cum_mean_error[3] = {0,0,0};

  std::cout<<"Number of times steps : "<<num_time_steps<<std::endl;
    ...
    std::cout<<"Ground Truth x : "<<gt[i].x<<", Best particle x : "<<best_particle.x<<std::endl;
    std::cout<<"Ground Truth y : "<<gt[i].y<<", Best particle y : "<<best_particle.y<<std::endl;
    std::cout<<"Ground Truth theta : "<<gt[i].theta<<", Best particle theta : "<<best_particle.theta<<std::endl;
